...
CHECK_SCRIPT="${ROOT_DIR}/scripts/check_final_ensemble_weight_submissions.sh"
WATCH_LOG="${ROOT_DIR}/local_artifacts/final_ensemble_weight_submission_watcher.log"
